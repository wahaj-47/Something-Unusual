...
//////////////////////////////////////////////////////////////////////////
// PaperZDToolViewportClient

class FPaperZDToolViewportClient : public FEditorViewportClient
{
public:
    /** Constructor */
    explicit FPaperZDToolViewportClient(const TWeakPtr<class SEditorViewport>& InEditorViewportWidget = nullptr);
    ~FPaperZDToolViewportClient();
