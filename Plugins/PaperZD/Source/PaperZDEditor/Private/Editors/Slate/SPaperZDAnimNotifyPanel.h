...
//Backwards support for slate versions
...
struct FPaperZDNotifyMarqueeOperation
{
	...
	void Start(const ZD::Slate::FVector2& InStartLocation, FPaperZDNotifyMarqueeOperation::Type InOperationType, TArray<TSharedPtr<SPaperZDAnimNotifyNode>>& InOriginalSelection)
	{
...
public:
	...
	void PanInputViewRange(int32 ScreenDelta, ZD::Slate::FVector2 ScreenViewSize);
	...
	FReply OnNotifyNodesDragStarted(TArray<TSharedPtr<SPaperZDAnimNotifyNode>> NotifyNodes, TSharedRef<SWidget> Decorator, const ZD::Slate::FVector2& ScreenCursorPos, const ZD::Slate::FVector2& ScreenNodePosition, const bool bDragOnMarker);
